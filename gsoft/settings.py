...
WSGI_APPLICATION = 'gsoft.wsgi.application'
...
# for S3 install $pip install boto3
AWS_STORAGE_BUCKET_NAME = os.getenv('AWS_STORAGE_BUCKET_NAME')
AWS_ACCESS_KEY_ID = os.getenv('AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SECRET_ACCESS_KEY')


# Specify the allowed file types, including SVG
AWS_ALLOWED_OBJECTS = [
    'image/jpeg',
    'image/png',
    'image/gif',
